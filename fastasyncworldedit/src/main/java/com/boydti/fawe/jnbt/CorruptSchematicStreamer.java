...
public class CorruptSchematicStreamer {
    ...
    public Clipboard recover() {
        try {
            ...
            match("Width", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    width.set(in.readShort());
                }
            });
            match("Height", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    height.set(in.readShort());
                }
            });
            match("Length", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    length.set(in.readShort());
                }
            });
            match("WEOffsetX", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    offsetX.set(in.readInt());
                }
            });
            match("WEOffsetY", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    offsetY.set(in.readInt());
                }
            });
            match("WEOffsetZ", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    offsetZ.set(in.readInt());
                }
            });
            match("WEOriginX", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    originX.set(in.readInt());
                }
            });
            match("WEOriginY", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    originY.set(in.readInt());
                }
            });
            match("WEOriginZ", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    originZ.set(in.readInt());
                }
            });
            match("Blocks", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
            ...
            match("AddBlocks", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    int length = in.readInt();
            ...
            match("Biomes", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    int length = in.readInt();
                    for (int i = 0; i < length; i++) {
            ...
            match("TileEntities", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
            ...
            match("Entities", new CorruptReader() {
                @Override
                public void run(DataInputStream in) throws IOException {
                    int childType = in.readByte();
                    int length = in.readInt();
