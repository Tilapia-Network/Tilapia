...
public class ParametricBuilder {
     ...
     * {@link com.sk89q.worldedit.util.command.parametric.InvokeHandler#preInvoke(Object, Method, ParameterData[], Object[], CommandContext)} to
     * be called for a invocation handler, but not the associated
     * {@link com.sk89q.worldedit.util.command.parametric.InvokeHandler#postInvoke(Object, Method, ParameterData[], Object[], CommandContext)}.</p>
     * <p>
     ...
     * in a {@link com.sk89q.worldedit.util.command.parametric.InvokeHandler#preInvoke(Object, Method, ParameterData[], Object[], CommandContext)}
